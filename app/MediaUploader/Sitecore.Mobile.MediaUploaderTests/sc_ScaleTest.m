...
-(void)testScale
{
    ...
    CGFloat coef = [ sc_ImageScaling scaleCoefficientToResizeImageWithSize: originalSize toSize: resultSize ];
    
    XCTAssertEqualWithAccuracy(coef, 0.8f, accuracy, @" wrong koef ");
    
    originalSize = CGSizeMake(200, 1000);
    resultSize = CGSizeMake(800, 600);
    coef = [ sc_ImageScaling scaleCoefficientToResizeImageWithSize: originalSize toSize: resultSize ];
